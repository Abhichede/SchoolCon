...
class StandardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create standard" do
    assert_difference('Standard.count') do
      post standards_url, params: { standard: { name: @standard.name, no_of_divisions: @standard.no_of_divisions } }
    end
  ...
  test "should update standard" do
    patch standard_url(@standard), params: { standard: { name: @standard.name, no_of_divisions: @standard.no_of_divisions } }
