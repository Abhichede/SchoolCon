...
class HomeworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post homeworks_url, params: { homework: { attachment: @homework.attachment, description: @homework.description, name: @homework.name, standard_id: @homework.standard_id } }
    end
  ...
  test "should update homework" do
    patch homework_url(@homework), params: { homework: { attachment: @homework.attachment, description: @homework.description, name: @homework.name, standard_id: @homework.standard_id } }
