...
class AssessmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assessment" do
    assert_difference('Assessment.count') do
      post assessments_url, params: { assessment: { assessment_name: @assessment.assessment_name, assessment_type: @assessment.assessment_type, division_id: @assessment.division_id, integer: @assessment.integer, max_marks: @assessment.max_marks, standard_id: @assessment.standard_id } }
    end
  ...
  test "should update assessment" do
    patch assessment_url(@assessment), params: { assessment: { assessment_name: @assessment.assessment_name, assessment_type: @assessment.assessment_type, division_id: @assessment.division_id, integer: @assessment.integer, max_marks: @assessment.max_marks, standard_id: @assessment.standard_id } }
